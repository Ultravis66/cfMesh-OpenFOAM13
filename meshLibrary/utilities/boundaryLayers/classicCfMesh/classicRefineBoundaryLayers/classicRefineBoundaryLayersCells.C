...
void classicRefineBoundaryLayers::generateNewCellsPrism
(
    const label cellI,
...
void classicRefineBoundaryLayers::storeFacesIntoCells
(
    const label faceI,
...
void classicRefineBoundaryLayers::refineEdgeHexCell::determineFacesInDirections()
{
...
void classicRefineBoundaryLayers::refineEdgeHexCell::populateExistingFaces()
{
...
void classicRefineBoundaryLayers::refineEdgeHexCell::generateMissingFaces()
{
    const cell& c = bndLayers_.mesh_.cells()[cellI_];
...
classicRefineBoundaryLayers::refineEdgeHexCell::refineEdgeHexCell
(
    const label cellI,
    const classicRefineBoundaryLayers& ref
)
:
    cellI_(cellI),
    nLayersI_(),
...
void classicRefineBoundaryLayers::refineCornerHexCell::determineFacesInDirections()
{
    const polyMeshGen& mesh = bndLayers_.mesh_;
    const cell& c = mesh.cells()[cellI_];
    const faceListPMG& faces = mesh.faces();
    ...
    forAllRow(splitEdgesAtPoint, commonPoint, i)
    {
        ...
        else
        {
            ...
            FatalErrorIn
            (
                "void classicRefineBoundaryLayers::refineCornerHexCell::"
                "determineFacesInDirections()"
...
void classicRefineBoundaryLayers::refineCornerHexCell::populateExistingFaces()
{
    const cell& c = bndLayers_.mesh_.cells()[cellI_];
...
void classicRefineBoundaryLayers::refineCornerHexCell::generateNewPoints()
{
    const cell& c = bndLayers_.mesh_.cells()[cellI_];
...
void classicRefineBoundaryLayers::refineCornerHexCell::generateMissingFaces()
{
...
classicRefineBoundaryLayers::refineCornerHexCell::refineCornerHexCell
(
    const label cellI,
    const classicRefineBoundaryLayers& ref
)
...
void classicRefineBoundaryLayers::generateNewCells()
{
