...
void classicBoundaryLayers::createLayerCells(const labelList& patchLabels)
{
    ...
    forAll(edgeFaces, edgeI)
    {
        ...
        if( pKeyI < 0 || pKeyJ < 0 )
        {
            ...
            FatalErrorIn
            (
                "void classicBoundaryLayers::createLayerCells(const labelList&)"
...
void classicBoundaryLayers::createNewFacesFromPointsParallel
(
