...
void classicBoundaryLayers::findPatchVertices
(
...
point classicBoundaryLayers::createNewVertex
(
    const label bpI,
    const boolList& treatPatches,
    ...
    if( patchVertex[bpI] & EDGENODE )
    {
        ...
        else if( otherPatches.size() == 2 )
        {
            ...
            if( otherVertex == -1 )
            {
                FatalErrorIn
                (
                    "void classicBoundaryLayers::createNewVertices"
                    "("
                        "const boolList& treatPatches,"
...
void classicBoundaryLayers::createNewVertices(const boolList& treatPatches)
{
...
void classicBoundaryLayers::createNewVertices(const labelList& patchLabels)
{
    otherVrts_.clear();
...
void classicBoundaryLayers::createNewPartitionVerticesParallel
(
...
void classicBoundaryLayers::createNewEdgeVerticesParallel
(
    const labelLongList& procPoints,
    const List<direction>& pVertices,
    const boolList& treatPatches
